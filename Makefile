...
# src files
SRCS = ./src/main.c ./src/utilities.c ./src/tiffFunctions.c ./src/inputFunctions.c ./src/determineCorrelation.c ./src/OpenCL_utilities.c ./src/dataArrangement.c ./src/gridFunctions.c
