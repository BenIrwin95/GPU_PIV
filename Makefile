...
# src files
SRCS = ./src/main.cpp ./src/OpenCL_utilities.cpp ./src/inputFunctions.cpp ./src/tiffFunctions.cpp ./src/dataArrangement.cpp ./src/FFT.cpp ./src/complexMaths.cpp ./src/determineCorrelation.cpp ./src/outputFunctions.cpp
